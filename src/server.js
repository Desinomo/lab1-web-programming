...
// const jwt = require('jsonwebtoken'); // 👈 (Видалено, тут він не потрібен)
...
// Ініціалізуємо Socket.IO (який вже має вбудовану автентифікацію)
const io = initSocket(server);

// --- (Рівень 2) Автентифікація WebSocket ---
// ❗️❗️❗️ ВЕСЬ ЦЕЙ БЛОК 'io.use(...)' ВИДАЛЕНО ❗️❗️❗️
// (Тому що він дублював логіку з 'socket.js' і був простішим)
// ------------------------------------------
